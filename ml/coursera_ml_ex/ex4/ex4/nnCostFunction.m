...
y_=zeros(k,1);
y_(y(i))=1;
J=J+sum((-y_'*log(h2')) - ((1-y_)'*log(1-h2')) );
...
Theta1_grad=Theta1_grad(2:input_layer_size+1);
Theta2_grad=Theta2_grad(2:hidden_layer_size+1);

Theta1_grad=Theta1_grad+ Theta1_grad*lambda/m;
